<?php
$this->layout('template', ['title' => 'Search Origin']);
?>

<div class="container my-5">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white">
            <h2 class="card-title text-center m-0">Search Origins</h2>
        </div>

        <div class="card-body">
            <?php if (!isset($searched) || !$searched): ?>
                <!-- Formulaire de recherche -->
                <form action="/TFT/index.php?action=search-origin" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="searchField" name="searchField">
                            <?php foreach ($originProperties as $property): ?>
            ...
            <?php else: ?>
                ...
                <div class="d-flex justify-content-evenly">
                    <a href="/TFT/index.php?action=search-origin" class="btn btn-primary p-2 fs-4">New Search</a>
